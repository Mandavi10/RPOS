...
namespace FRDWeb.Reports
{
    public partial class PaymentTransaction : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ds = objManager.FillDatasetWithParam("sp_Report", "@QueryType", "@RestroId", "@FromDate", "@ToDate", "@SectionId", "@UserId", "@take", "@UserIdd", "RevenuePayment",
                restroid, date, todate, section, userid, itemgroupid, UserIId);

            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/PaymentTransactionWiseReport.rdlc"); //D:\Rproject\FRD_Web\FRDWeb\FRDWeb\Reports\PaymentTransactionWiseReport.rdlc
            ReportDataSource datasource = new ReportDataSource("PaymentTerms", ds.Tables[0]);
            //ReportDataSource datasource1 = new ReportDataSource("DataSet2", ds.Tables[1]);
            //ReportDataSource datasource2 = new ReportDataSource("DataSet5", ds.Tables[2]);
