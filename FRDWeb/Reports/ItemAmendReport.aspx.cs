...
{
    public partial class ItemAmendReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ds = objManager.FillDatasetWithParam("sp_Report", "@QueryType", "@RestroId","@FromDate", "@ToDate"
                        , "@UserId", "BindAmendOrder", restroid, date, todate, UserId);



            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/ItemAmendReport.rdlc");
