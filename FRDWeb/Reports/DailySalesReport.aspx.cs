...
namespace FRDWeb.Reports
{
    public partial class DailySalesReport : System.Web.UI.Page
    {
       ...
       // DataTable dt;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
          ...
          string todate = Convert.ToString(Session["todate"]); //RestroMenuLevel2Id datatable_Name.Rows.Count
    ...
    , "@UserId", "DailySalesReport", restroid, date, todate, itemgroupid, UserId);
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/DailySalesReport.rdlc");
