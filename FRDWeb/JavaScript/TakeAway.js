...
jquery_min_p(document).ready(function () {
    ...
    const myParam = urlParams.get('OrderTypeId');
    // OrderType = myParam;
    
    if (myParam != null) {
        getordertypeid(myParam);
    ...
    const myParam2 = urlParams.get('OrderId');
    if (myParam2 != null) {
        gettemporderid(myParam2);
...
jquery_min_p("#btnexitrunning").click(function () {
    ...
    jquery_min_p("#txtinputitem").on("keyup", function () {
        ...
        jquery_min_p("#divlevel11 .menuItemBox").filter(function () {
...
function getordertypeid(OrderType)
{
    ...
    jquery_min_p.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "/DineInTakeAway/BindOrderType",
...
function getorderid(neworder) {
    ...
    jquery_min_p.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "/DineInTakeAway/BindOrderidtakeaway",
        ...
        success: function (result) {
            ...
            for (var i = 0; i < ArrayCount; i++) {
                if (result[i].name == 'Chinese') {
                    ...
                    Query = Query + "<div class='menuItemBox' id='level1_" + '' + result[i].RestroMenuLevel1Id + "' onclick='BindLevel1(" + result[i].RestroMenuLevel1Id + ")'>"
                    Query = Query + "<div class='imgheight'><img src='../../Content/images/chinese.png' /></div>"
                    Query = Query + " <h6>" + result[i].name + "</h6>"
                    Query = Query + "</div>"
                    // hitems
                    jquery_min_p("#lblitems").val(result[i].name);
                }
            ...
            jquery_min_p("#divlevel11").append(Query);
            ResCarouselSize();
...
function BindLevel1(RestroMenuLevel1Id, name) {
    ...
    jquery_min_p('#divlevel11 .menuItemBox').removeClass('active');
        ...
        success: function (result) {
            ...
            if (ArrayCount > 0) {
                ...
                for (var i = 0; i < ArrayCount; i++) {
                    ...
                    //jquery_min_p("#lblitems").val(result[i].itemname);
                }
            ...
            jquery_min_p.ajax({
                ...
                success: function (result) {
                    ...
                    if (result.length > 0) {
                        ...
                        jquery_min_p("#divnodata").css("display", "none");
                        //jquery_min_p("#divpageHead").css("display", "block");
                        jquery_min_p("#divpageHead").css('visibility', 'visible');
...
function IncQty() {
    ...
    //    data: "{'restroid':'" + restroid + "','RestroMenuItemId':'" + RestroMenuItemId + "','orderid':'" + orderid + "','Qty':'" + Qty + "','neworderid':'" + neworderid + "','itemId':'" + itemId + "'}",
    //    dataType: "json",
    //    async: false,
    //    success: function (result) {
    ...
    if (neworderid == 0) {
       ...
       // restroid = jquery_min_p("#lblrestroid").text();
        ...
        jquery_min_p.ajax({
            ...
            data: "{'restromenuid':'" + restromenuid + "','restroid':'" + restroid + "','orderid':'" + orderid + "','neworderid':'" + neworderid + "','OrderType':'" + OrderTypeid + "'}",
            dataType: "json",
            async: false,
            success: function (result) {
                var i = 0;
...
function gettemporder() {
    ...
    jquery_min_p.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "/DineInTakeAway/gettemporder",
        data: "{'OrderType':'" + OrderTypeid + "','restroid':'" + restroid + "'}",
        dataType: "json",
        async: false,
        success: function (result) {
            var i = 0;
            orderid=result[i].temporderno;
        }
    });
}
